...
| Feature                                                                              | Description                                                                                   |
| :----------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------- |
| [**XtendM3 CRUD Generator**]({% link docs/features/xtendm3-crud-generator.md %})     | Generate full CRUD transactions for custom tables with code preview and upload directly to M3 |
